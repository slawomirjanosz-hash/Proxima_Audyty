    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #e8f0ed;">
                ...
                <td style="padding:6px 12px;"><textarea name="df_offer_description" class="ot-input" rows="2" style="margin:0;" placeholder="Domyślny opis lub wstęp oferty...">{{ old('df_offer_description') }}</textarea></td>
            </tr>
            <tr style="border-bottom:1px solid #e8f0ed;background:#fafcfb;">
            ...
            <tr style="border-bottom:1px solid #e8f0ed;">
                ...
                <td style="padding:6px 12px;"><textarea name="df_payment_terms_text" class="ot-input" rows="2" style="margin:0;" placeholder="np. Płatność 100% po wykonaniu audytu, 14 dni od faktury.">{{ old('df_payment_terms_text', 'Płatność na podstawie faktury VAT, 14 dni od wystawienia.') }}</textarea></td>
            </tr>
            <tr style="border-bottom:1px solid #e8f0ed;background:#fafcfb;">

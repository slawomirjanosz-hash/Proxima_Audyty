...
<head>
    ...
    <title>ENESA | Audyty energetyczne</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero-heading-main {
            ...
            line-height: 1.08;
            font-weight: 800;
            background: linear-gradient(90deg, var(--green-primary) 0%, #0c5f28 100%);
        ...
        .badge {
            ...
            letter-spacing: .6px;
            text-transform: uppercase;
            background: rgba(16, 143, 204, 0.12);
            border: 1px solid rgba(16, 143, 204, 0.25);
            color: #08608c;
        }
        ...
        .offer-grid .offer-card:nth-child(5) {
            grid-column: span 1;
        }
...
<body>
    ...
    <div class="shell">
            ...
            <ul class="menu">
                ...
                @else
                    ...
                    @if(!$menuUser->isClient() && $menuUser->canAccessTab(\App\Models\User::TAB_OFFER))
                        <li><a href="{{ route('oferta') }}">{{ __('ui.menu.offer') }}</a></li>
                    @endif
        ...
        <main class="content">
            ...
            <section class="hero">
                <div class="hero-logo">
                    <img src="/Logo2.png" alt="ENESA Logo">
                </div>
                <div class="badge">Industrial Audits</div>
                <div class="hero-heading">
                    <p class="hero-heading-main">ENESA sp. z o. o.</p>
                    <p class="hero-heading-sub">Audyty energetyczne</p>
                </div>
                <p class="muted">
                    Zaawansowane audyty energetyczne, analiza efektywnosci oraz profesjonalne raportowanie
                    dla sektora komercyjnego i przemyslowego. Precyzja danych, techniczne podejscie i
                    standard wykonania gotowy dla rynku miedzynarodowego.
                </p>
            </section>
        </main>
    </div>

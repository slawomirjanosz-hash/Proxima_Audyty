                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex;gap:2px;">
                                        <button type="button" onclick="moveRow(this,'up','{{ $sectionId }}')" class="o-btn-sm" style="background:#e2e8f0;color:var(--ink);" title="Wyżej">↑</button>
                                        <button type="button" onclick="moveRow(this,'down','{{ $sectionId }}')" class="o-btn-sm" style="background:#e2e8f0;color:var(--ink);" title="Niżej">↓</button>
...
function addRow(section) {
    ...
    tr.innerHTML = `
        ...
        <td>
            <div style="display:flex;gap:2px;">
                <button type="button" onclick="moveRow(this,'up','${section}')" class="o-btn-sm" style="background:#e2e8f0;color:var(--ink);" title="Wyżej">↑</button>
                <button type="button" onclick="moveRow(this,'down','${section}')" class="o-btn-sm" style="background:#e2e8f0;color:var(--ink);" title="Niżej">↓</button>

<x-layouts.app>
    <section class="panel">
        ...
        <form method="POST" action="{{ route('dashboard.audits.update', $audit) }}">
            @csrf
            @method('PATCH')
            ...
            <div style="margin-top:14px; display:flex; justify-content:flex-end; gap:8px;">
                <a href="{{ route('dashboard', ['tab' => 'in-progress']) }}" class="btn-secondary" style="text-decoration:none; padding:8px 10px; border-radius:9px;">Anuluj</a>
